...
$(document).ready(function(){
   function paper(){
      ...
      function render(){
         ...
         console.log(that.orgx,that.orgy);
         ...
         for(var i=0;i<that.strokes.length;++i){
            stroke_render(that.strokes[i],0);
         }
         ...
         that.mouseup=function(ev){
            if('down' in that){
               ...
               if(drag){ // finish drag 
                  ...
                  console.log('pop',paper.orgx,paper.orgy);
               ...
               if(draw){ // finish draw
                  console.log('here',paper.strokes);
                  paper.strokes.push(that.current_stroke);
                  console.log('end');
